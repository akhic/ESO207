...
int Is_Expression(char* val){
    if(val[0] =='+'||val[0] =='-'||val[0] =='*'||val[0] =='/'||val[0] =='^'||val[0] =='%'||val[0] =='('||val[0] ==')'||val[0]=='~' ){
        return 1;
    }
    else{
        return 0;
...
int check_invalid(char* exp){
    ...
    while(i<len+1){
        ...
        if(prev[0]!='a'){
            ...
            if(prev[0]=='('&&val[0]!='('&&val[0]!='~'&&Is_Expression(val)){
                return 1;
            }
            if(val[0] =='('&&!Is_Expression(prev)){
                return 1;
            }
            if(val[0] !='('&&prev[0]!= '('&&val[0] !=')'&&prev[0]!= ')'&&val[0]!='~'&&prev[0]!='~'&&Is_Expression(prev)&&Is_Expression(val)){
                return 1;
            }
            ...
            if(val[0]!='('&&Is_Expression(prev)&&val[0]!='~'){
                return 1;
            }
        }
...
void convert_minus(char* exp){
    ...
    while(i<len+1){
        ...
        if(prev[0]=='a'){
            ...
            if(prev[0]!=')'&&Is_Expression(prev)&&val[0]=='-'){
                exp[i-1] = '~';
            }
        }
